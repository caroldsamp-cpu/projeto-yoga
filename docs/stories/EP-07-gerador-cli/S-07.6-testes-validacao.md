...
Como **PM do projeto Mente Leve**, quero **testar o gerador CLI gerando 20 roteiros, validando com a Gaby e medindo a taxa de aprovacao**, para que **tenhamos confianca de que a ferramenta produz conteudo autenticamente Sadhana e iteremos os prompts ate atingir qualidade aceitavel**.
...
- [ ] Organizar roteiros em pasta `tests/roteiros-gerados/`
  ...
  ├── 01-ansiedade-marina-reel30.md
  ├── 02-ansiedade-julia-reel60.md
  ├── ...
  └── 20-consistencia-camila-story.md
  ```
