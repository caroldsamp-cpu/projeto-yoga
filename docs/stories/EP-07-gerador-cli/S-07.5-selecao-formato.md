...
Como **criadora de conteudo do NamaSer**, quero **selecionar o formato de saida (reel 30s, reel 60s, carrossel, story, post feed) ao gerar um roteiro no CLI**, para que **o conteudo ja venha estruturado para a plataforma e duracao que vou usar, sem precisar adaptar manualmente**.
...
- 5 formatos de conteudo mais usados pelo NamaSer no Instagram
