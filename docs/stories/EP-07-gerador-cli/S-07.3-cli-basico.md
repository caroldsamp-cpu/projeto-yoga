...
Como **criadora de conteudo do Mente Leve**, quero **digitar um tema no terminal e receber um roteiro pronto com tom Sadhana**, para que **eu possa gerar conteudo consistente sem depender de inspiracao ou reescrita manual do tom**.
