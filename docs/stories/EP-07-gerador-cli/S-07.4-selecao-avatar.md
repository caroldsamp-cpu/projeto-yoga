...
Como **criadora de conteudo do NamaSer**, quero **selecionar um avatar (Marina, Julia ou Camila) ao gerar um roteiro no CLI**, para que **o conteudo seja personalizado para a dor, tom e contexto da audiencia especifica que quero alcan̤ar**.
