...
**Tom:** Acolhedor. Como se estivesse sentada com a Gaby no sofa, explicando.
...
em algo ainda mais poderoso, claro e bonito.
...
## SECAO 2: POR QUE MUDAR?

### Titulo
O que esta acontecendo hoje

### Texto
Voce tem um curso incrivel. 5 trilhas, 14 modulos, mais de 100 aulas. Tudo organizado com carinho, com profundidade, com a sua presenca em cada video.

Mas a maioria das mulheres que poderiam se transformar com o seu trabalho nao sabe que voce existe. E as que sabem, muitas vezes nao entendem exatamente o que voce oferece.
...
### Dados que importam
- Voce tem 700 mulheres no WhatsApp que ja demonstraram interesse
- 80% delas nao conhecem a plataforma ainda
...
## SECAO 3: O QUE E SADHANA?

### Titulo
Sadhana: a palavra que muda tudo
...
O ponto nao e o que voce faz. E que voce faz todos os dias, com intencao.
...
Quando voce diz "5 minutos ja e suficiente", isso e Sadhana.
Quando voce diz "pode fazer de pijama, na cama", isso e Sadhana.
Quando voce diz "voltar ja e ser constante", isso e Sadhana.
Quando voce diz "presenca, nao performance", isso e Sadhana.

A diferenca e que agora a gente vai dar nome a isso. E quando algo tem nome, as pessoas conseguem encontrar, entender e compartilhar.
...
| Antes | Depois | Por que melhora |
|-------|--------|----------------|
| "Comunidade de yoga" | "Seu ritual de presenca" | Sai do generico, entra no pessoal |
| "Regulacao emocional" | "Presenca no dia real" | Sai do clinico, entra no humano |
| "10 minutos" | "5 minutos todos os dias" | Reduz a barreira, aumenta a consistencia |
| "Atraves do movimento" | "Na vida como ela e" | Sai do tapete, entra na cozinha, no transito, na cama |

### Destaque visual (card ou caixa)
Nao estamos mudando o que voce ensina.
Estamos mudando como o mundo entende o que voce ensina.
...
### Titulo
Receitas Sadhana: o coracao da proposta

### Texto introdutorio
Receitas Sadhana sao formatos simples de pratica que qualquer mulher pode fazer no seu dia real. Nao exigem tapete, roupa especial ou silencio. Cada receita dura entre 3 e 5 minutos e se encaixa em um momento especifico do dia.

A ideia e que a aluna escolha UMA receita e faca todo dia por 7 dias. Depois pode variar, combinar, criar sua propria rotina. Mas comeca simples.

### As 5 Receitas

**O Despertar**
Quando: Ao acordar, antes do celular
O que: Sentar na beira da cama. 3 respiracoes profundas. Perguntar: "como eu quero me sentir hoje?"
Duracao: 5 minutos
O que muda: Voce conecta com seu corpo antes de qualquer pressao do dia te atingir.

**A Transicao**
Quando: No intervalo do trabalho, ou mudanca de atividade
O que: Pausar tudo. Alongar o pescoco lentamente. Respirar fundo sentindo cada movimento.
Duracao: 3 minutos
O que muda: Voce quebra o ciclo de estresse. Seu corpo descomprime. Voce volta com mais clareza.

**O Nutrir**
Quando: Ao tomar cafe, agua ou cha
O que: Sentir a temperatura da xicara nas maos. Respirar o aroma. Beber lentamente, sentada.
Duracao: 5 minutos
O que muda: Uma acao automatica vira ritual. Presenca em algo que voce ja estava fazendo.

**O Purificar**
Quando: Lavando louca, dobrando roupa, limpando
O que: Focar na sensacao. Sentir a agua nas maos, a textura do pano. Sincronizar respiracao com movimento.
Duracao: 5 minutos
O que muda: Tarefa entediante vira ritual meditativo.

**O Encerrar**
Quando: Na cama, antes de dormir
O que: Repassar o dia rapidamente. Observar sem julgar. Respirar fundo e soltar tudo.
Duracao: 5 minutos
O que muda: Seu corpo integra o aprendizado do dia. Voce dorme mais profundo.

### Destaque visual (card ou caixa)
As receitas nao substituem suas aulas. Elas COMPLEMENTAM.
Sao a ponte entre o tapete e a vida real.
A aluna faz a receita no dia a dia e aprofunda nas trilhas.
...
**Nenhuma aula muda.** Nenhuma e removida, editada ou reordenada.
...
### Destaque visual (card ou caixa)
Resumindo: mesmo conteudo, nova historia.
Suas aulas permanecem intactas.
O que muda e como a aluna entende o caminho que percorre.
...
- Explica o que e Sadhana de forma simples e bonita
- Apresenta as 5 Receitas
- Convida a aluna a escolher UMA receita e fazer por 7 dias
- Conecta com a primeira trilha (Fundacao)

### Por que precisa existir
Sem essa porta de entrada, a aluna chega e ve 100+ aulas. Fica paralisada. Com a Entrada Sadhana, ela tem um caminho claro: "comeca aqui, faz isso por 7 dias, depois a gente conversa."

E como quando voce recebe alguem em casa: voce nao mostra todos os comodos de uma vez. Voce oferece um cha, senta no sofa, e a conversa vai fluindo naturalmente.

### O que voce precisa gravar
Este modulo pode ser simples:
- 1 video de boas-vindas (voce falando, estilo conversa, 3-5 minutos)
- 1 video ou texto explicando as 5 Receitas (2-3 minutos)
- Texto de orientacao dentro da plataforma (a gente escreve pra voce)
...
## SECAO 9: O QUE VOCE GANHA COM ISSO
...
- Elas se sentem autorizadas a fazer pouco (5 minutos basta)
- Elas pertencem a algo (uma tribo de mulheres que vivem Sadhana, nao que fazem yoga)
- Elas voltam sem culpa quando param (porque "voltar ja e ser constante")

### Para o negocio
- As 700 mulheres no WhatsApp recebem uma mensagem clara e acolhedora de convite
- O Instagram ganha direcao: conteudo organizado em categorias que fazem sentido
- O funil de conversao fica natural (descoberta no Instagram, entrada pelo quiz, acolhimento no WhatsApp, experiencia na plataforma)
- Retencao aumenta porque Sadhana e habito de identidade, nao "assinatura de app de yoga"

---

## SECAO 10: O QUE ACONTECE AGORA
...
Seu papel: Ler, sentir se ressoa, ajustar o que precisar.
Resultado: O framework Sadhana pronto e validado.

### Fase 2: Validacao (Semana 3-4)
O que: Testar o manifesto e as receitas com 10 mulheres reais (dos seus 3 perfis de aluna).
Seu papel: Possivelmente participar de 1-2 conversas. Ouvir o feedback.
Resultado: Saber se o Sadhana ressoa com mulheres reais, nao so com a gente.

### Fase 3: Reposicionamento das Trilhas (Semanas 4-6)
O que: Renomear trilhas, escrever novas descricoes, criar o Guia de Navegacao.
Seu papel: Aprovar os novos nomes e descricoes. Gravar 1-2 videos curtos de boas-vindas.
Resultado: Plataforma reposicionada com narrativa Sadhana.

### Fase 4: Conteudo e Comunicacao (Semanas 7-9)
O que: Criar o calendario de conteudo do Instagram, roteiros de reels, estrategia de stories.
Seu papel: Gravar os reels (com roteiro pronto). Ser voce mesma na camera.
Resultado: Instagram com conteudo estrategico, acolhedor e consistente.

### Fase 5: Ativacao (Semanas 10-12)
O que: Lancar o reposicionamento para as 700 mulheres do WhatsApp. Abrir inscricoes.
Seu papel: Estar presente. Acolher. Responder.
Resultado: Primeiras alunas entrando ja com a experiencia Sadhana completa.

### Destaque visual (card ou caixa)
Na maior parte do tempo, voce so precisa fazer o que ja faz:
ser voce mesma, com presenca, na frente da camera.
O resto a gente constroi ao redor de voce.

---

## SECAO 11: ENCERRAMENTO

### Texto
Gaby,

Tudo que esta aqui nasceu do seu trabalho. Das suas aulas. Das suas palavras. Da forma como voce guia cada respiracao.
...
Agora vamos deixar o mundo saber disso.
...
## NOTAS PARA O DESIGN (@ux-design-expert / @dev)
...
- Tabela comparativa simples na Secao 4 (Antes/Depois)
- 5 icones SVG para as Receitas (sol, setas, xicara, agua, lua)
- Mapa visual das trilhas na Secao 6 (diagrama simples mostrando a jornada)
- Timeline visual na Secao 10 (5 fases com linha conectando)
- Icone SVG de porta/entrada para o modulo novo (Secao 7)

### Paleta sugerida
- Background: #FDF8F4 (creme quente)
- Texto principal: #3D3A38 (cinza escuro quente, nao preto puro)
- Destaque: #6B7B5E (verde-terra suave)
- Accent: #C4A882 (dourado/areia)
- Secoes alternando: creme / branco / creme

### Tipografia sugerida
- Titulos: Playfair Display (elegante, com serifa)
- Corpo: Inter ou DM Sans (limpa, moderna, legivel)
- Muito espacamento entre linhas (1.8)
- Paragrafos curtos (3-4 linhas no maximo)
