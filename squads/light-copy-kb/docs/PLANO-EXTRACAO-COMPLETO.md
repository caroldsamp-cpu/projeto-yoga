...
| 1.3 | M3 — Elementos Literarios (Light Copy) | 31 transcricoes | framework + SOP + checklist | [x] |
| 1.4 | M4 — Aplicacao & Analises Praticas | 23 transcricoes (18 M4 + 5 analises) | framework + SOP + checklist | [x] |
