...
**Agent**: @marketing-ideation -> @marketing-cmo -> @marketing-production -> @marketing-designer -> @marketing-distribution
**Version**: 1.0.0
...
### Step 2: Ideacao (@marketing-ideation)
...
3. Se houver visual, salvar arte/brief associado
